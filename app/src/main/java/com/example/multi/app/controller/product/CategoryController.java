...
import com.example.multi.app.domain.category.CategoryChildrenVO;
import com.example.multi.app.domain.category.CategoryGeneralListVO;
import com.example.multi.app.domain.category.CategoryListCellVO;
import com.example.multi.app.domain.category.CategoryListVO;
...
public class CategoryController {
    ...
    public Response getCategoryList() {
        ...
        return new Response(1001, parentListVO);
    }


    @GetMapping("/category/children")
    public Response getCategoryChildren(@RequestParam BigInteger id) {
        ...
        return new Response(1001, childrenVO);
    }
